                    ...
                    {this.state.userInfo && this.props.cartArr.length>0 && this.props.cartArr.map((item, index)=>{
                        return (
                            ...
                            <li key={item.id}>
                                ...
                                <div className="info">          
                                    <Link to={"/productroom/detail/" + item.goods_id } className="good_img">
                                ...
                                <div className="sub_total">
                                    {/* {item.price * item.goods_num} */}

                                    {this.state.userInfo.roleId && <span>{ item.discountPrice  * item.goods_num }</span>}
                                    {this.state.supplyPriceStatusValue != null && this.state.supplyPriceStatusValue==1 &&<span>{ item.discountPrice * item.goods_num }</span>}
